        ...
        <div className="py-12 space-y-12 animate-fade-in text-left">
            <div className="flex items-center gap-6 mb-10 border-b border-white/5">
                <button
                    ...
                    className={`pb-4 text-xs uppercase tracking-[0.2em] transition-all border-b-2 ${settingsTab === 'GENERAL' ? 'text-white border-white font-bold' : 'text-neutral-600 border-transparent hover:text-neutral-400 font-normal'}`}
                >
                    General
                </button>
                <button
                    onClick={() => setSettingsTab('BILLING')}
                    className={`pb-4 text-xs uppercase tracking-[0.2em] transition-all border-b-2 ${settingsTab === 'BILLING' ? 'text-white border-white font-bold' : 'text-neutral-600 border-transparent hover:text-neutral-400 font-normal'}`}
                >
                    Billing
                </button>
            </div>
            ...
            {settingsTab === 'GENERAL' ? (
                ...
                <div className="py-20 flex flex-col items-center justify-center bg-neutral-900/20 rounded-md border border-dashed border-white/5">
                    <p className="text-xs font-bold text-neutral-500 uppercase tracking-widest">Billing controls coming soon</p>
                </div>
            )}
        </div>
    );
